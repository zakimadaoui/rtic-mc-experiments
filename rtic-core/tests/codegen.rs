...
fn codegen_expands_single_core_app() {
    ...
    assert_section_present(
        &generated,
        quote! { pub use rtic_traits :: * ; },
        "rtic_traits re-export",
    );

    // ---- interrupt-free critical section function ----
    assert_section_present(
        &generated,
        quote! { pub fn __rtic_interrupt_free < F , R > (f : F) -> R where F : FnOnce () -> R },
    ...
    assert_section_present(
        &generated,
        quote! { const _ : fn () = || { __rtic_trait_checks :: implements_rtic_task :: < UartTask > () ; } ; },
        "task trait check",
    );
    assert_section_present(
        &generated,
    ...
    assert_section_present(
        &generated,
        quote! { impl UartTask { pub const fn current_core () -> __rtic__internal__Core0 { unsafe { __rtic__internal__Core0 :: new () } } } },
    ...
    assert_section_present(
        &generated,
        quote! { const _ : fn () = || { __rtic_trait_checks :: implements_rtic_idle_task :: < Idle > () ; } ; },
        "idle trait check",
    );
    assert_section_present(
        &generated,
...
fn codegen_expands_multi_core_app() {
    ...
    assert_section_present(
        &generated,
        quote! { const _ : fn () = || { __rtic_trait_checks :: implements_rtic_task :: < UartTask0 > () ; } ; },
    ...
    assert_section_present(
        &generated,
        quote! { impl UartTask0 { pub const fn current_core () -> __rtic__internal__Core0 { unsafe { __rtic__internal__Core0 :: new () } } } },
    ...
    assert_section_present(
        &generated,
        quote! { pub use core0_type_mod :: __rtic__internal__Core0 ; },
    ...
    assert_section_present(
        &generated,
        quote! { const _ : fn () = || { __rtic_trait_checks :: implements_rtic_task :: < UartTask1 > () ; } ; },
    ...
    assert_section_present(
        &generated,
        quote! { impl UartTask1 { pub const fn current_core () -> __rtic__internal__Core1 { unsafe { __rtic__internal__Core1 :: new () } } } },
    ...
    assert_section_present(
        &generated,
        quote! { pub use core1_type_mod :: __rtic__internal__Core1 ; },
