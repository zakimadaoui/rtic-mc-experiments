pub mod my_app {
    ...
    impl MyTask2 {
        pub fn spawn(
            ...
            __rtic_interrupt_free(|| -> Result<(), <MyTask2 as RticSwTask>::SpawnInput> {
                ...
                unsafe { ready_producer.enqueue_unchecked(Core0Prio2Tasks::MyTask2) };
    ...
    impl MyTask7 {
        pub fn spawn(
            ...
            __rtic_interrupt_free(|| -> Result<(), <MyTask7 as RticSwTask>::SpawnInput> {
                inputs_producer.enqueue(input)?;
                unsafe { ready_producer.enqueue_unchecked(Core0Prio2Tasks::MyTask7) };
                __rtic_sc_pend(rp2040_hal::pac::Interrupt::DMA_IRQ_0 as u16);
                Ok(())
            })
        }
    ...
    #[derive(Clone, Copy)]
    #[doc(hidden)]
    pub enum Core0Prio2Tasks {
        MyTask2,
        MyTask7,
    }
    #[doc(hidden)]
    #[allow(non_upper_case_globals)]
    static mut __rtic_internal__Core0Prio2Tasks__RQ: rtic::export::Queue<Core0Prio2Tasks, 3usize> =
        rtic::export::Queue::new();
    ...
    static mut MY_TASK7: core::mem::MaybeUninit<MyTask7> = core::mem::MaybeUninit::uninit();
    struct MyTask7;
    ...
    impl MyTask7 {
        pub fn shared(&self) -> __my_task7_shared_resources {
            const TASK_PRIORITY: u16 = 2u16;
            __my_task7_shared_resources::new(TASK_PRIORITY)
        }
    }
    struct __my_task7_shared_resources {
        pub led: __led_mutex,
    }
    impl __my_task7_shared_resources {
        #[inline(always)]
        pub fn new(priority: u16) -> Self {
            Self {
                led: __led_mutex::new(priority),
    ...
    static mut CORE0_PRIORITY2_DISPATCHER: core::mem::MaybeUninit<Core0Priority2Dispatcher> =
        core::mem::MaybeUninit::uninit();
    #[doc(hidden)]
    ...
    fn DMA_IRQ_0() {
        unsafe {
            CORE0_PRIORITY2_DISPATCHER.assume_init_mut().exec();
        }
    }
    ...
    impl RticMutex for __alarm_mutex {
        ...
        fn lock(&mut self, f: impl FnOnce(&mut Alarm0)) {
            ...
            let resource = unsafe { &mut SHARED_RESOURCES.assume_init_mut().alarm } as *mut _;
            unsafe {
                rtic::export::lock(
                    resource,
                    task_priority,
    ...
    impl RticMutex for __led_mutex {
        ...
        fn lock(&mut self, f: impl FnOnce(&mut LedOutPin)) {
            const CEILING: u16 = 3u16;
            let task_priority = self.priority;
            let resource = unsafe { &mut SHARED_RESOURCES.assume_init_mut().led } as *mut _;
            unsafe {
                rtic::export::lock(
                    resource,
                    task_priority,
    ...
    const __rtic_internal_MASK_CHUNKS_core0: usize = rtic::export::compute_mask_chunks([
        ...
        rp2040_hal::pac::Interrupt::DMA_IRQ_0 as u32,
    ]);
    #[doc(hidden)]
    #[allow(non_upper_case_globals)]
    ...
    pub fn main() -> ! {
        __rtic_interrupt_free(|| {
            unsafe {
                ...
                CORE0_PRIORITY2_DISPATCHER.write(Core0Priority2Dispatcher::init());
            }
            ...
            unsafe {
                rp2040_hal::pac::CorePeripherals::steal()
                    .NVIC
                    .set_priority(rp2040_hal::pac::Interrupt::TIMER_IRQ_0, 3u16 as u8);
                rp2040_hal::pac::NVIC::unmask(rp2040_hal::pac::Interrupt::TIMER_IRQ_0);
                rp2040_hal::pac::CorePeripherals::steal()
                    .NVIC
                    .set_priority(rp2040_hal::pac::Interrupt::TIMER_IRQ_2, 1u16 as u8);
                rp2040_hal::pac::NVIC::unmask(rp2040_hal::pac::Interrupt::TIMER_IRQ_2);
                rp2040_hal::pac::CorePeripherals::steal()
                    .NVIC
                    .set_priority(rp2040_hal::pac::Interrupt::DMA_IRQ_0, 2u16 as u8);
