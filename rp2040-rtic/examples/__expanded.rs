pub mod rtic_app {
    ...
    #[doc = r" ======================== define static mut shared resources ========================="]
    ...
    impl RticMutex for __alarm_mutex {
        ...
        fn lock(&mut self, f: impl FnOnce(&mut Alarm0)) {
            ...
            unsafe {
                rtic::export::lock(resource, task_priority, CEILING, &__rtic_internal_MASKS, f);
            }
        }
    }
    struct __led_mutex {
    ...
    #[doc = r"======================== define and bind hw tasks to interrupts ======================"]
    ...
    static mut PRIORITY2_DISPATCHER: core::mem::MaybeUninit<Priority2Dispatcher> =
        core::mem::MaybeUninit::uninit();
    #[doc(hidden)]
    ...
    fn DMA_IRQ_0() {
        unsafe {
            PRIORITY2_DISPATCHER.assume_init_mut().exec();
        }
    }
    #[doc = r" ==================================== rtic traits ===================================="]
    pub use rtic_traits::*;
